...
import org.oclc.loganalyzer.Analyzer;
 ...
 * @author levan
 */
public abstract class AccessLogAnalyzer extends Analyzer {
...
//            return sb.toString();
    ...
    public static AccessLogAnalyzer getAnalyzer(String analyzerName) {
        Class<? extends AccessLogAnalyzer> c;
        AccessLogAnalyzer analyzer;
        String        name=getAnalyzerClassName(analyzerName);

        try {
            c=Class.forName(name).asSubclass(AccessLogAnalyzer.class);
        }
